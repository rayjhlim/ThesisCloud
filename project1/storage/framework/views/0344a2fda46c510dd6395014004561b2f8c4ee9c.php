...
<html lang="<?php echo e(config('app.locale')); ?>">
    <head>
        ...
        <script type="text/javascript" src="<?php echo e(URL::asset('js/example/example.words.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo e(URL::asset('js/html2canvas.js')); ?>"></script>
